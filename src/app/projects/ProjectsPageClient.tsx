      ...
      <section className="relative pt-32 pb-20 bg-white dark:bg-brand-black">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">Explore 250+ successfully delivered projects across residential, commercial, and industrial sectors.</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filtered.map((project, i) => (
              <motion.div key={project.title} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} layout className="group rounded-2xl overflow-hidden bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-brand-yellow transition-all duration-300 shadow-md">
                ...
                <div className="p-6">
                  <h3 className="text-lg font-bold text-brand-black dark:text-white font-[family-name:var(--font-heading)] mb-2">{project.title}</h3>
                  <p className="text-gray-700 dark:text-gray-300 font-medium text-sm leading-relaxed mb-4">{project.desc}</p>
                  <div className="flex items-center gap-4 text-gray-600 dark:text-gray-400 font-bold text-sm">
