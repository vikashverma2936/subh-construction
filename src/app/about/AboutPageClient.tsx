      ...
      <section className="py-20 bg-brand-yellow">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-heading)] text-brand-black dark:text-white mb-6">Want to Work With Us?</h2>
            <p className="text-gray-600 dark:text-gray-400/80 font-medium text-lg mb-8">Join hundreds of satisfied clients who chose SUBH Construction for their dream projects.</p>
            <a href="/contact" className="inline-flex items-center gap-2 bg-white dark:bg-brand-black text-brand-black dark:text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 dark:bg-white/5 transition-all hover:scale-105">
