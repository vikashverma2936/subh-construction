      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link
              href="/contact"
              className="flex items-center gap-2 bg-brand-yellow text-brand-black px-5 py-2.5 rounded-full font-semibold text-sm hover:bg-brand-yellow-dark transition-all duration-200 hover:shadow-lg hover:shadow-brand-yellow/25"
            >
              <Phone size={16} />
              Get Quote
            </Link>
            ...
            <div className="px-4 py-6 space-y-1">
              ...
              <div className="pt-4">
                <Link
                  href="/contact"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center justify-center gap-2 bg-brand-yellow text-brand-black px-5 py-3 rounded-full font-semibold hover:bg-brand-yellow-dark transition-all"
                >
                  <Phone size={16} />
                  Get Free Quote
                </Link>
