    ...
    <footer className="bg-brand-black border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-lg font-bold font-[family-name:var(--font-heading)] text-white ml-1">Construction</span>
              </div>
            </Link>
            ...
            <div className="flex gap-3">
              {socials.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-brand-blue-light flex items-center justify-center text-gray-400 hover:bg-brand-yellow hover:text-brand-black transition-all duration-200"
                >
                  <social.icon size={18} />
                </a>
              ))}
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white font-semibold font-[family-name:var(--font-heading)] text-lg mb-6">Quick Links</h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-400 hover:text-brand-yellow transition-colors text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Services */}
          <div>
            <h3 className="text-white font-semibold font-[family-name:var(--font-heading)] text-lg mb-6">Our Services</h3>
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service}>
                  <Link href="/services" className="text-gray-400 hover:text-brand-yellow transition-colors text-sm">
                    {service}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact */}
          <div>
            <h3 className="text-white font-semibold font-[family-name:var(--font-heading)] text-lg mb-6">Contact Info</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="mailto:info@subhconstruction.com" className="text-gray-400 hover:text-brand-yellow text-sm transition-colors">
